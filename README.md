...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/easyargs-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/easyargs-feedstock)
...
Once the `conda-forge` channel has been enabled, `easyargs` can be installed with:

```
conda install easyargs
```

It is possible to list all of the versions of `easyargs` available on your platform with:
